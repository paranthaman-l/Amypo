...
const DeclineLeave = ({ open, setOpen, cancelButtonRef, getData, data }) => {
    const handleSubmit = (e) => {
        e.preventDefault();
        Services.declineLeave(data.lid).then((response) => {
            toast.custom((t) => (
                <div
                    ...
                    <div className="flex items-center gap-2 text-white">
                        ...
                        <div>
                            <span className="">Leave Decline successFull !</span>
                        </div>
                    </div>
                </div>
            ));
                                ...
                                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                    <div className="sm:flex sm:items-start flex justify-center items-center w-full">
                                        ...
                                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                                            ...
                                            <div className="">
                                                <p className="indent-4 font-poppins">Do you want to approve the leave?</p>
                                                <div className="flex flex-col w-full ">
                                                    ...
                                                    <div className="flex flex-col w-full mt-2 ml-10">
                                                        <p>Start Date <span className="font-semibold ">
                                                                : {new Date(data?.dateFrom).toLocaleDateString('en-US', { year: 'numeric', month: 'short', day: 'numeric' })}</span>
                                                        </p>
                                                        <p>To Date <span className="font-semibold ml-4">
                                                                : {new Date(data?.dateTo).toLocaleDateString('en-US', { year: 'numeric', month: 'short', day: 'numeric' })}</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
